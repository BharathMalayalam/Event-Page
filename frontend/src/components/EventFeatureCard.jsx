      ...
      <div className="relative h-full space-y-4">
        ...
        <div className="space-y-4 px-1 pb-2 sm:px-2">
          <div className="space-y-1">
            <h3 className="text-lg font-black tracking-tight text-slate-800 transition-colors duration-300 group-hover:text-sky-700 sm:text-xl">
              {event.title}
            </h3>
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-3 text-[10px] font-bold text-slate-500 sm:text-xs">
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-sky-50 text-sky-600 transition-colors group-hover:bg-sky-600 group-hover:text-white">
                <FaSchool size={12} />
              </div>
          ...
          <motion.button
            ...
            className="relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-slate-900 py-3 text-xs font-black uppercase tracking-widest text-white transition-all duration-300 hover:bg-sky-700 hover:shadow-lg hover:shadow-sky-200 sm:py-3.5 sm:text-sm"
          >
